...
assert.ok(script.includes('data.priorityFocus'), 'primary focus marker must exist');
assert.ok(script.includes('data.priorityOthers'), 'secondary carousel marker must exist');
